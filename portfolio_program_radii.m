%% uncertainty in objective: test the impact of the Wasserstein radii
clc
clear all
close all
...
for time = 1:1
    ...
    %eps = 1/sqrt(m);
    theta = 0.01;
    eps = [10^-4:0.0001:10^-3,0.002:0.001:10^-2,0.02:0.01:0.1,0.2:0.1:1];
    ...
    for i=1:num
        ...
        f = c'*x + lambda*eps(i) + sum(s)/m; %目标函数
